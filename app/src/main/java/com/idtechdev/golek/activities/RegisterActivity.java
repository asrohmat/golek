package com.idtechdev.golek.activities;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //radio button get id
        radioLevelGroup = (RadioGroup) findViewById(R.id.level);
...
//        final String radiovalue = this.radioLevelButton.getText().toString().trim();
        // radioButton text
        final String radiovalue = (String) radioLevelButton.getText();

        if (selectedId <= 0) {
            Toast.makeText(getApplicationContext(), "Choose Radio Button Please", Toast.LENGTH_SHORT).show();
        }

//        if(radiovalue == null){//No Radio Button Is Checked
...
//        String URL_REGISTER = "https://data.didinstudio.com/didin-api/login/add";
        String URL_REGISTER = "http://192.168.1.6/golek-api/login/add";
